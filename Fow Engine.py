import chess
#To do: SETUP MYSQL HERE? CONFIRM THAT THIS PROPERLY PULLS THE DATA TABLE FROM FRONT END, FIX/REPLACE SCORING AND EVALUATION FUNCTIONS, FIGURE OUT HOW TO 
###PROPERLY GET MINIMAX TO GIVE US TOP K MOVES FOR OPPONENT, FIGURE OUT HOW TO PROPERLY REMMOVE "GUESS" PIECES FROM OUR TRACKING TABLE WHEN THE ACTUAL PIECE IS VISIBLE
###################################################################################################
